  ...
  return (
    ...
    >
      ...
      >
        ...
        {visualBadge ? (
          <div className="absolute bottom-6 right-6 flex items-center gap-2 rounded-pill border border-border-hover bg-[#0a0a0b99] py-1.5 px-3 backdrop-blur-[8px]">
            <span
              aria-hidden="true"
      ...
      {badge ? (
        <div className="absolute top-4 left-4 rounded-pill border border-border-hover bg-[#0a0a0b99] py-1 px-2.5 backdrop-blur-[8px]">
